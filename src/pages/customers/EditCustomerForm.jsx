...
const EditCustomerForm = ({
  ...
  const editItemMutation = useMutation(({ item, customerId }) => editCustomer({ item, customerId }), {
    onSuccess: (data) => {
      if (data.data?.error) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button type="primary" htmlType="submit" loading={editItemMutation.isLoading} disabled={disabledSubmitButton}>
          Պահպանել
        </Button>
      </Form.Item>
    </Form>

...
const OrderCard = ({
  ...
  const orderImageUrls =
    orderImages?.map((img) => formatImageUrl(delve(img, 'attributes.url'))) ||
    [];
  ...
  return (
    <Card
      ...
      // cover={
      //   orderImage ? (
      //     <Image src={formatImageUrl(orderImage)} />
      //   ) : (
      //     <Image
      //       src="error"
      ...
      // }
      cover={
        !orderImageUrls.length ? (
          <Image
            src="error"
            fallback="data:image/png;base64,"
          />
        ) : (
          <Image.PreviewGroup items={orderImageUrls}>
            <Image
              // width={50}
              src={orderImageUrls[0]}
              placeholder={
                <Image
                  preview={false}

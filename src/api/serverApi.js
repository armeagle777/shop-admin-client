...
export const getOrders = async () => {
    const response = await serverApi.get(
        `/orders?filters[isActive][$eq]=true&pagination[pageSize]=1000&populate[customer][populate]=*&populate[shop][populate]=*&populate[images][populate]=*&populate[category][populate]=*&sort[0]=id:desc`
    );
